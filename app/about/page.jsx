        ...
        <div style={{ maxWidth: MAX_W, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '24px' }}>
            {[
              ...
              { icon: '🤝', title: 'A Real Consulting Relationship', body: 'Weekly Zoom calls. Live team training. Hands-on document building. We are actively involved in your certification every week for the duration of your engagement, not just available by email if you have a question.' },
